...
class Car:
    ...
    def cast(self, walls):
        ...
        for i in range(len(observations)):
            ...
            observations[i] = max(0.0, min(1.0, observations[i] + noise))
...
class RacingEnv:
    ...
    def step(self, action):
        ...
        ####### 🎯 Add speed-based reward here  #########
        speed_reward = self.car.vel / self.car.maxvel
        reward += 0.1 * speed_reward  # tweak weight if needed
        #######                                ##########
